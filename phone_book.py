...
5 - удалить контакт
6 - перенести контакт в другой файл
7 - выход
------------------------------- \n
""")

# Вызов функции по добавлению нового человека
...
def addition():
    with open(file_path, 'a', encoding='utf8') as open_book:
        ...
        new_line = add_surname + ' '+add_name + ' ' + add_phone
        open_book.writelines(f'\n{new_line}')
        print(new_line)

# Вызов функции по поиску человека (по параметрам)
